        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-6 pb-32">
          ...
          {isAnswering && (
            <div className="flex w-full justify-start">
              <div className="max-w-[26rem] rounded-[22px] rounded-tl-sm bg-white px-5 py-4 shadow-[0_12px_30px_-26px_rgba(28,87,70,0.45)]">
                <div className="flex items-center gap-2">
                  <span className="h-2 w-2 animate-pulse rounded-full bg-[#67d3bb]" />
                  <span
                    className="h-2 w-2 animate-pulse rounded-full bg-[#67d3bb]"
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-[linear-gradient(180deg,rgba(238,253,248,0)_0%,rgba(238,253,248,0.96)_25%,rgba(238,253,248,1)_100%)] px-6 pb-6 pt-14">
        <div className="mx-auto max-w-5xl space-y-3">
          {/* <div className="flex flex-wrap gap-2">
            {conversation.promptOptions.map((prompt: boolean | Key | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined) => (
              <button
                key={prompt}
                type="button"
